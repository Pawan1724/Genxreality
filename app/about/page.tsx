...
import { Linkedin, Users, Zap, Globe, DollarSign } from 'lucide-react';
    ...
    <div className="pt-24">
      ...
      <div className="relative h-[50vh] w-full overflow-hidden mb-12">
        ...
        <div className="absolute bottom-0 left-0 w-full p-8 md:p-16">
          <Container>
            <h1 className="text-5xl md:text-7xl font-bold mb-4 uppercase tracking-tighter">About <span className="text-brand-primary">GenXReality</span></h1>
